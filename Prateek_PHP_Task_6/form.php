...
class form{
    ...
    function download_file(){
        ...
        // Writing the text in it using fwrite function
        ...
        $txt = "Subject | Marks" ."\n";
        fwrite($myfile, $txt);
        // Iterating into the marks table and fetching marks and storing it.
        foreach ($this->subject_marks_table() as $subject => $marks) {
            $txt = " ".$subject . " | " . $marks. "\n" ;
            fwrite($myfile, $txt);
        }
        // Closing the file
        fclose($myfile);
        // Creating a download link to download the file 
    ...
    function echo_download(){
        ...
        // Printing or reading the file and displaying it when we click submit button.
